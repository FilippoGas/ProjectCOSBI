...
data_downsample_4_patients <- subset(data,
                                     subset = Sample_Name %in% c("THD0005", "THD0005", "TILD037", "TILD037"))
data_lung_epi <- subset(data,
                        subset = cytopus %in% c("lung-epi"))
```
...
data_downsampled_4000@meta.data <- data_downsampled_4000@meta.data %>%
                        ...
                        left_join(nicola_dict, by = "manual_annotation_1") %>% 
                        column_to_rownames("barcode")
data_downsample_4_patients@meta.data <- data_downsample_4_patients@meta.data %>%
                        rownames_to_column("barcode") %>%
                        left_join(cytopus_dict, by = "manual_annotation_1") %>%
                        left_join(nicola_dict, by = "manual_annotation_1") %>% 
                        column_to_rownames("barcode")
...
# Mixed annotation
Create a column with cytopus annotations for all cells, substitute lung-epi with the manual annotation
```{r}
data@meta.data <- data@meta.data %>% 
                        mutate(mixed_annotation = ifelse(cytopus=="lung-epi", manual_annotation_1, cytopus))
```
...
SaveH5Seurat(data, filename = "/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/AnnData/Natri_et_al_no_QC.h5Seurat", overwrite = TRUE)
Convert("/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/AnnData/Natri_et_al_no_QC.h5Seurat", dest = "h5ad", overwrite = TRUE)

# QC
DefaultAssay(data_qc) <- "RNA"
data_qc <- DietSeurat(data_qc, assays = "RNA", layers = "data", dimreducs = NULL, graph = NULL)
SaveH5Seurat(data_qc, filename = "/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/AnnData/Natri_et_al_QC.h5Seurat", overwrite = TRUE)
Convert("/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/AnnData/Natri_et_al_QC.h5Seurat", dest = "h5ad", overwrite = TRUE)
...
SaveH5Seurat(data_downsampled_2000, filename = "/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/AnnData/Natri_et_al_downsampled_2000.h5Seurat", overwrite = TRUE)
Convert("/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/AnnData/Natri_et_al_downsampled_2000.h5Seurat", dest = "h5ad", overwrite = TRUE)
...
SaveH5Seurat(data_downsampled_4000, filename = "/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/AnnData/Natri_et_al_downsampled_4000.h5Seurat", overwrite = TRUE)
Convert("/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/AnnData/Natri_et_al_downsampled_4000.h5Seurat", dest = "h5ad", overwrite = TRUE)

DefaultAssay(data_downsample_4_patients) <- "RNA"
data_downsample_4_patients <- DietSeurat(data_downsample_4_patients, assays = "RNA", layers = "data", dimreducs = NULL, graph = NULL)
SaveH5Seurat(data_downsample_4_patients, filename = "/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/AnnData/Natri_et_al_downsampled_4patients.h5Seurat", overwrite = TRUE)
Convert("/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/AnnData/Natri_et_al_downsampled_4patients.h5Seurat", dest = "h5ad", overwrite = TRUE)

DefaultAssay(data_lung_epi) <- "RNA"
data_lung_epi <- DietSeurat(data_lung_epi, assays = "RNA", layers = "data", dimreducs = NULL, graphs = NULL)
SaveH5Seurat(data_lung_epi, filename = "/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/AnnData/Natri_et_al_downsampled_lung-epi.h5Seurat", overwrite = TRUE)
Convert("/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/AnnData/Natri_et_al_downsampled_lung-epi.h5Seurat", dest = "h5ad", overwrite = TRUE)
```
