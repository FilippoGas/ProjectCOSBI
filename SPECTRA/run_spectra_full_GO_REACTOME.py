...
def main():
    ...
    geneset_db_name     = sys.argv[4]
    # INPUT PATHS
    geneset_db_path     = sys.argv[5]
    ...
    # OUTPUT PATHS
    model_pickle_path       = "/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/SPECTRA/full/"+annotation_type+"_annotation_"+geneset_db_name+"/Natri_et_al_full_"+annotation_type+"_anno_spectra_model_"+pbs_job_id+".pickle"
    anndata_pickle_path     = "/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/SPECTRA/full/"+annotation_type+"_annotation_"+geneset_db_name+"/Natri_et_al_full_"+annotation_type+"_anno_AnnData_"+pbs_job_id+".pickle"
    gene_scores_csv_path    = "/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/SPECTRA/full/"+annotation_type+"_annotation_"+geneset_db_name+"/Natri_et_al_full_"+annotation_type+"_anno_gene_scores_"+pbs_job_id+".csv"
    cell_scores_csv_path    = "/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/SPECTRA/full/"+annotation_type+"_annotation_"+geneset_db_name+"/Natri_et_al_full_"+annotation_type+"_anno_cell_scores_"+pbs_job_id+".csv"
    factor_markers_csv_path = "/shares/CIBIO-Storage/BCG/scratch/fgastaldello/COSBI/data/IPF_datasets/Natri_et_al/SPECTRA/full/"+annotation_type+"_annotation_"+geneset_db_name+"/Natri_et_al_full_"+annotation_type+"_anno_factor_markers_"+pbs_job_id+".csv"

    # LOAD DATA
    # Load gene sets dictionary from cytopus
    with open(geneset_db_path, 'r') as f:
        geneset_db = json.load(f)
    ...
    trained_model = spc.est_spectra(adata=adata,
                                    gene_set_dictionary=geneset_db,
                                    L=None,
